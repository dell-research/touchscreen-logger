...
import com.dell.research.touchscreenlogger.deviceinfo.DeviceInfo;
...
/**
 * Created by irwin_reyes on 10/30/15.
 */
public class GestureDataWriter {
     ...
     * @param filename Name of the destination file. Will be placed under /sdcard/SwipeDataLogger/
     */
    ...
    private void init(Context c) {
        ...
        outputFolder = new File(Environment.getExternalStorageDirectory(), "SwipeDataLogger");

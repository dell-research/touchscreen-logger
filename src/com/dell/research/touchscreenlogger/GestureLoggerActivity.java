...
public class GestureLoggerActivity extends Activity {
    ...
    private String getDeviceReport() {
        ...
        buffer.append("loggerBuild : " + com.dell.research.touchscreenlogger.version.Version.BUILD + "\n");
        buffer.append("loggerDate : " + com.dell.research.touchscreenlogger.version.Version.DATE+ "\n");
